...
def coordinate(type):
    ...
    if type == 'cartesian':
        ...
        def next(pt, step, dir, dim):
            ...
            debug_msg("%s nxtpt %s "%(type, nxtpt))
            return nxtpt#[0:dim]
